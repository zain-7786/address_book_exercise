...
import { Row,Col,Input, Space, Card, Affix } from 'antd';
...
//             <Affix offsetTop={top}><Input placeholder="Search Users" enterButton size="middle" value={searchTerm} onChange={handleChange}/></Affix>
